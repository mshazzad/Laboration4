package com.example.Laboration4;
...
public class CalculatorTests {
    ...
    void canAddNumber() {
        ...
        Assertions.assertEquals(result, 9);  // check failing test by using 8 instead of 9
    }
    @Test
    ...
    @Test
    void canFindNaNDuringGetCircumference() {
        double result = calculator.getCircumference(-1);
        Assertions.assertFalse(result== Double.NaN);
    }
